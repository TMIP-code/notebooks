...
python scripts/get_all_transport_terms_nonCMIParchive.py $model $experiment $year_start $num_years \
&> output/$PBS_JOBID.$model.datafromTilo.$year_start.$num_years.out
