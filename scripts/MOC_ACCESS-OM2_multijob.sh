...
#     sed "s/OM2run_placeholder/$OM2run/g" scripts/MOC_ACCESS-OM2-1.sh > tmp.sh
#     qsub tmp.sh
#     rm tmp.sh
# done
...
#     # change placeholders in script, submit, and clean up
#     sed "s/OM2run_placeholder/$OM2run/g" scripts/MOC_ACCESS-OM2-025.sh > tmp.sh
#     qsub tmp.sh
#     rm tmp.sh
# done
...
#     # change placeholders in script, submit, and clean up
#     sed "s/OM2run_placeholder/$OM2run/g" scripts/MOC_ACCESS-OM2-01.sh > tmp.sh
#     qsub tmp.sh
#     rm tmp.sh
# done

sed "s/OM2run_placeholder/01deg_jra55v150_iaf_cycle1/g" scripts/MOC_ACCESS-OM2-01.sh > tmp.sh
qsub tmp.sh
rm tmp.sh